    ...
    public partial class frmGeplandeAankopen : Form
    {
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                worksheet.Cells[2, 6] = "Aangevraagd bedrag";
                worksheet.Cells[2, 7] = "Overschreden/niet gebruik bedrag";
                worksheet.Cells[2, 8] = "PlanningsDatum";
                worksheet.Cells[2, 9] = "Extra Bedrag";
                worksheet.Cells[2, 10] = "Totaal Prijs";
                //layout title
                ...
                worksheet.get_Range("C1", "J200").ColumnWidth = 20;
                worksheet.get_Range("E2", "G200").NumberFormat = "0.00 €";
                worksheet.get_Range("I2", "J200").NumberFormat = "0.00 €";
        ...
        public void ColorExcel(int pos, int month, Excel.Worksheet ws, bool even, bool m)
        {
            ...
            if (m)
            {
                ...
                {
                    c = MaandL;
                    ws.get_Range("A" + pos, "J" + pos).Interior.Color = c;
                }
                //month is uneven
                else
                {
        ...
        private void frmGeplandeAankopen_Load(object sender, EventArgs e)
        {
            ...
            ddlFinancieringsjaar.ValueMember = "Financieringsjaar";
        ...
        private void ddlFinancieringsjaar_SelectedIndexChanged(object sender, EventArgs e)
        {
            btnExcel.Enabled = !string.IsNullOrEmpty(ddlFinancieringsjaar.SelectedValue.ToString());
        }
    }
}
